...
from stream.v3_optimized import (
    OptimizedCamera,
    RealtimeDetector
)
...
def _frame_producer():
    """
    Thread que captura, processa e comprime
    ...
    while True:
        ...
        # Comprime para JPEG
        # qualidade 80 = bom equilíbrio tamanho/qualidade
        ok, jpg = cv2.imencode(
            ".jpg",
            annotated,
...
def _generate_mjpeg():
    """
    Generator que produz o stream multipart
    para o cliente HTTP.
    """
...
def index():
    ...
    <body>
        ...
        <p>
            Stream MJPEG com inferência YOLO
            e anotações em tempo real.
        </p>
    </body>
    </html>
    """
...
def health():
    """
    Health check compatível com o padrão
