...
Buffer de 1 frame elimina o acúmulo e garante processamento do frame
atual.
...
class CameraCapture:
    ...
    def __init__(
        ...
        # Buffer de 1 frame:
        # producer sobrescreve, consumer lê o mais recente
    ...
    def _capture_loop(self):
        ...
        while self._running.is_set():
            ...
            # Mantém só o último frame JPEG completo;
            # descarta os anteriores
    ...
    def read(self, timeout: float = 1.0):
        ...
        Bloqueia até timeout se nenhum disponível.
        """
...
def main():
    ...
    print(
        f" Frames descartados    : {camera.frames_dropped} "
