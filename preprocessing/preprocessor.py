"""
Módulo central de pré-processamento de imagens
para o projeto yolo-edge-api.
...
class Preprocessor:
    ...
    Não mantém estado mutável entre frames.
    """
